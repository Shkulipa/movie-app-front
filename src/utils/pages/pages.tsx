...
const LazyCreateMovie = lazy(
	() => import('src/components/pages/createMovie/createMovie')
);
const LazyError404 = lazy(
	() => import('src/components/pages/error404/error404')
);
const LazyError500 = lazy(
	() => import('src/components/pages/error500/error500')
);
 ...
 * @info auth pages
 */
const LazyMovieFavorites = lazy(
	() => import('src/components/pages/movieFavorites/movieFavorites')
);
